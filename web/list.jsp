            ...
            <table border="1" class="table table-bordered table-hover">
                ...
                <c:forEach items="${pb.list}" var="user" varStatus="s">
                    <tr>
                        ...
                        <td>${user.email}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/findUserServlet?id=${user.id}" class="btn btn-warning">修改</a>
                            <a href="javascript:deleteUser(${user.id});" class="btn btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
